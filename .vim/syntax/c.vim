...
hi  cFunction	gui=NONE	guifg=#0033FF
...
syn match   	cFunction "\<[a-zA-Z_][a-zA-Z_0-9]*\>[^()]*)("me=e-2
syn match	cFunction "\<[a-zA-Z_][a-zA-Z_0-9]*\>\s*("me=e-1
hi cFunction 	term = none 	cterm=none 	ctermfg=DarkCyan
"""========================================================
...
" Hightlight Class and Function names
"syn match	cCustomFunc	"\w\+\s*("me=e-1
"hi cCustomFunc 	cterm=none 	ctermfg=darkcyan
