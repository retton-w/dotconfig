...
"   - UnEscape() and DeEscape() functions to reverse Escape() to compliment
...
"   - OptClearBuffer() function to clear the contents of the current buffer in
"     an optimum manner.
